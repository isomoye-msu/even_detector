...
set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { a[2] }]; #IO_L4N_T0_34 Sch=SW2
...
##LEDs
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { even }]; #IO_L23P_T3_35 Sch=LED0
